...
export const INITIAL_HOLLOW_KNIGHT_CHECKLIST_STATE: HollowKnightChecklistState =
    {
        ...
        checks: {
            ...
            charms: {
                ...
                '[Gathering Swarm]': {
                    description:
                        'Bought from [Sly] in [Dirtmouth] for [GEO] 300.',
                    reward: { percent: 1, charms: 1, geoReq: 300 },
                    requires: { geo: 300 },
                },
                '[Stalwart Shell]': {
                    description:
                        'Bought from [Sly] in [Dirtmouth] for [GEO] 200.',
                ...
                '[Shape of Unn]': {
                    description:
                        'Acquired from [Unn] beneath the [Lake of Unn].',
                    reward: { percent: 1, charms: 1 },
                    requires: {
                        checks: {
                            equipment: { "[Isma's Tear]": { checked: true } },
            ...
            maskShards: {
                '[Sly] #1': {
                    description:
                        'Bought from [Sly] in [Dirtmouth] for [GEO] 150.',
                    reward: { maskShards: 1, geoReq: 150 },
                    requires: { geo: 150 },
                },
                '[Sly] #2': {
                    description:
                        'Bought from [Sly] in [Dirtmouth] for [GEO] 500.',
                ...
                '[Sly] #3': {
                    description:
                        'Bought from [Sly] in [Dirtmouth] for [GEO] 800.',
                ...
                '[Sly] #4': {
                    description:
                        'Bought from [Sly] in [Dirtmouth] for [GEO] 1500.',
                ...
                "[Bretta]'s house": {
                    description:
                        'Requires rescuing [Bretta] from [Fungal Wastes].',
                    reward: { maskShards: 1 },
                    requires: {
                        checks: {
                            equipment: {
                ...
                '[Grey Mourner]': {
                    description:
                        'Requires completing the [Delicate Flower quest].',
                    reward: { maskShards: 1 },
                    requires: {
                        checks: {
            ...
            vesselFragments: {
                '[Sly] #1': {
                    description:
                        'Bought from [Sly] in [Dirtmouth] for [GEO] 550.',
                    reward: { vesselFragments: 1, geoReq: 550 },
                    requires: { geo: 550 },
                },
                '[Sly] #2': {
                    description:
                        'Bought from [Sly] in [Dirtmouth] for [GEO] 900.',
            ...
            items: {
                '[SIMPLE_KEY] [Simple Key] from [Sly]': {
                    description:
                        'Bought from [Sly] in [Dirtmouth] for [GEO] 950.',
                ...
                '[Lumafly Lantern]': {
                    description:
                        'Bought from [Sly] in [Dirtmouth] for [GEO] 1800.',
                    reward: { geoReq: 1800 },
                    requires: { geo: 1800 },
                },
                '[Delicate Flower]': {
